...
│                                               │
│  Physics Engine ──── LiDAR & State ──→ Agent Brain (PPO Policy)
│       ↑                      ↓              │
│  Reward/Penalty ← Velocity Action           │
│       ↑                                      │
│  Critic Network ─── Update Gradients ────→ │
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│  Curriculum Manager                          │
│                                               │
│  Success Rate Monitor ──→ Adjust Difficulty → Agent
│                                               │
│  Phase 1: Static → Phase 2: Dynamic → Phase 3: Long Range
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│  Real World Deployment                       │
│                                               │
│  Load Weights → Jetson Orin Nano ──→ Control Signals → Real Robot
└─────────────────────────────────────────────────┘
```
...
- **Phase 3: 長程導航 (Long-Range Navigation) - [目前階段]**
  ...
  - *技術亮點*：引入 **自適應課程 (Adaptive Curriculum)**，自動根據成功率調整目標距離 (2m-15m)，確保訓練效率。
